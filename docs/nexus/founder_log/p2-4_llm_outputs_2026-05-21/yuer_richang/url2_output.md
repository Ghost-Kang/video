# P2-4 改写输出 · yuer_richang #2

**源 URL**: https://www.douyin.com/video/7029849085913943329
**源 @作者**: 钻爸的古村落生活
**源日期**: 2021-11-13
**源标题**: 当孩子读的书,比我烧过的菜还多,宠娃除了厨艺配锅铲,还嘚请台神灯
**hook_pattern_id**: `H7+H5`
**source_classification**: `positive`
**rewrite_id**: `rw_285d29f8378ae07d`
**model**: `p2-4-synth-v1`
**confidence**: 0.75
**cost_cny**: ¥0.4200
**机械检查**: 10/11 通过
...
```
### 改写脚本
<!-- 保留:H7+H5 · 当孩子读的书,比我烧过的菜还多,宠娃除了厨艺配锅铲,还嘚请台神灯 | hook_pattern_id=H7+H5 | classification=positive | 改:换成育儿日常视角和家庭场景 -->
