# P2-4 改写输出 · yuer_richang #3

**源 URL**: https://www.douyin.com/video/7496042444683021619
**源 @作者**: 妍爸妍妈
**源日期**: 2025-04-22
**源标题**: 记录妍妍肉肉放学后的vlog #带娃日常 #我的带娃日常 #记录生活
**hook_pattern_id**: `H6`
**source_classification**: `positive`
**rewrite_id**: `rw_b9addd5c3dac446f`
**model**: `p2-4-synth-v1`
**confidence**: 0.75
**cost_cny**: ¥0.4200
**机械检查**: 11/11 通过
...
```
### 改写脚本
<!-- 保留:H6 · 记录妍妍肉肉放学后的vlog #带娃日常 #我的带娃日常 #记录生活 | hook_pattern_id=H6 | classification=positive | 改:换成育儿日常视角和家庭场景 -->
...
- ✅ hook_diversity — 2 distinct hooks: ['H6', 'H8']
